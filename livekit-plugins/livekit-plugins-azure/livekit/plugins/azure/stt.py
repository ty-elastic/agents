...
class SpeechStream(stt.SpeechStream):
    ...
    def _start_stream_recognition(self, data : rtc.AudioFrame) -> speechsdk.audio.PushAudioInputStream:
        ...
        def recognized_cb(evt: speechsdk.SpeechRecognitionEventArgs):
            ...
            if (evt.result.reason == speechsdk.ResultReason.RecognizedKeyword or evt.result.reason == speechsdk.ResultReason.RecognizedSpeech) and len(evt.result.text) > 0:
    ...
    async def _run(self) -> None:
        ...
        while not closed:
            ...
            if isinstance(data, rtc.AudioFrame):
                ...
                #print(f"{frame.sample_rate}, {frame.data.nbytes}")
